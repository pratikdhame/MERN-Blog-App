  ...
  return (
    <section className="post-detail">
      <div className="container post-detail__container">
        ...
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi ex distinctio praesentium tempora aut nesciunt obcaecati nulla illo consectetur! Quia, sunt sint minus officia magnam inventore culpa nostrum impedit necessitatibus, recusandae quisquam voluptate sapiente. Voluptas ipsam quas, aut, itaque perferendis debitis necessitatibus sapiente vitae tempora libero, minus veritatis ullam eum?
        </p>
        <p>
